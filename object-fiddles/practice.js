...
//Create another 'me' object with the following properties name, age, height, gender, married, 
...
var me = {
  name: 'Evan',
  age: 31,
  height: 'Six feet',                   //not sure how to use singular apostrophe (ex. 6'0) 
  gender: 'male',
  married: false,
  eyeColor: 'Green',
  hairColor: 'Brown'
...
//Now call the sayName method that's on the user object which will alert the user email
...
methodCollection.alertHello = function() {                    //NEED HELP////////////////////////////////
  alert('Hello');
}
...
var user2 = {
    name: 'Evan Palsson',
    email: 'evanpalsson.com',
    password: 'supertrooper',
    username: 'Bob'
}

var user3 = {
    name: 'Kenny Howard',
    email: 'kennyhoward.com',
    password: 'starshiptrooper',
    username: 'Marley'
}
...
for (var i = 0; i < users.length; i++) {
  if (users[i].email === 'tylermcginnis33@gmail.com') {
      users.splice(i, 1);                           //Correct code because it removes the object from the array
   }
}

for (var i = 0; i < users.length; i++) {
  if (users[i].email === 'tylermcginnis33@gmail.com') {
      delete users[i];                  //Incorrect code because it leaves the spot in the array open as undefined
   }
}
